...
BUFFER_HOOK_SIG(default_new_file){
  const char *Header =
    "/**************************************************************\n"
    " **   Miguel Amaro Copyright whatever                        **\n"
    " **                                                          **\n"
    " **                                                          **\n"
    " **                                                          **\n"
    " **                                                          **\n"
  ...
  if (string_match(string_postfix(file_name, 2), string_u8_litexpr(".c"))) {
    Date_Time date_time = {0};
    date_time = system_now_date_time_universal();
    date_time = system_local_date_time_from_universal(&date_time);
    ...
    insertf(&insert,
            ...
            "%s"
            "\n",
            string_expand(date_string), Header);
    end_buffer_insertion(&insert);
  }
